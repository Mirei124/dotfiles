...
# Example format: plugins=(zsh-autosuggestions zsh-syntax-highlighting fzf z rails git textmate ruby lighthouse)
# Add wisely, as too many plugins slow down shell startup.
plugins=(zsh-autosuggestions zsh-syntax-highlighting fzf z git)
